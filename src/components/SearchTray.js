...
const SearchTray = (props) =>{
    return(
        ...
        <div className={classes['Search-Tray']}>
            ...
            <hr />
        <button onClick={props.onClick} className={`${classes.catchers} ${classes.catchers3}` }><p> Add guests </p><SearchIcon fontSize="small" className={classes.searchIcon}/> </button>
        </div>
        </>
    )
}
